...
(function(Fa, T, k) {
    var S = function(g) {
        ...
        function y(a, b, c, e) {
            ...
            if (c === k) return a.iDrawError != d && null === i && (J(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b, 4), a.iDrawError = d), i;
        ...
        function na(a, b, c, e) {
            var d = [],
                ...
                jb = function(a) {
                    if (c === k || c === j) i = l[j], n = g.trim(a.innerHTML), i && i._bAttrSrc ? (Q(i.mData._)(e, n), q(i.mData.sort, a), q(i.mData.type, a), q(i.mData.filter, a)) : r ? (i._setter || (i._setter = Q(i.mData)), i._setter(e, n)) : e[j] = n;
                    j++
                };
            if (f)
                for (; f;) {
        ...
        function kb(a) {
            ...
            j && (d = g("<tr/>").appendTo(h));
            b = 0;
            for (c = l.length; b < c; b++) f = l[b], e = g(f.nTh).addClass(f.sClass), j && e.appendTo(d), a.oFeatures.bSort && (e.addClass(f.sSortingClass), !1 !== f.bSortable && (e.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Pa(a, f.nTh, b))), f.sTitle != e[0].innerHTML && e.html(f.sTitle), Qa(a, "header")(a, e, f, n);
            j && ea(a.aoHeader, h);
        ...
        function ub(a) {
            ...
            }), q("mDataProp_" + h, j), e.bFilter && (q("sSearch_" + h, l.sSearch), q("bRegex_" + h, l.bRegex), q("bSearchable_" + h, n.bSearchable)), e.bSort && q("bSortable_" + h, n.bSortable);
        ...
        function zb(a) {
            ...
            for (f = a.aoData.length; e < f; e++)
                if (g = a.aoData[e], !g._aFilterData) {
                    i = [];
                    d = 0;
                    for (h = b.length; d < h; d++) c = b[d], c.bSearchable ? (j = y(a, e, d, "filter"), l[c.sType] && (j = l[c.sType](j)), null === j && (j = ""), "string" !== typeof j && j.toString && (j = j.toString())) : j = "", j.indexOf && -1 !== j.indexOf("&") && (wa.innerHTML = j, j = $b ? wa.textContent : wa.innerText), j.replace && (j = j.replace(/[\r\n]/g, "")), i.push(j);
                    g._aFilterData = i;
        ...
        function V(a) {
            ...
            for (a = 0; a < n.length; a++) {
                ...
                f = d[j].aDataSort;
                b = 0;
                for (c = f.length; b < c; b++) h = f[b], i = d[h].sType || "string", n[a]._idx === k && (n[a]._idx = g.inArray(n[a][1], d[h].asSorting)), e.push({
                    src: j,
                    col: h,
                    dir: n[a][1],
                    index: n[a]._idx,
            ...
            if ("ssp" != z(a) && 0 !== n.length) {
                ...
                h === n.length ? g.sort(function(a, b) {
                    var c, d, h, i, g = n.length,
                        ...
                        k = f[b]._aSortData;
                    for (h = 0; h < g; h++)
                        if (i = n[h], c = j[i.col], d = k[i.col], c = c < d ? -1 : c > d ? 1 : 0, 0 !== c) return "asc" === i.dir ? c : -c;
                    c = e[a];
                    d = e[b];
